...
# Notes
# - GUI command builder: `python scripts\command_builder_gui.py`
#   - Lets you tick options, fill values, copy the generated command, or write it to `WATCHDOG_TAPO_COMMAND` in `.env`.
